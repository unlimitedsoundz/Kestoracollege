...
const faqs: FAQItem[] = [
    {
        question: "Who is required to pay tuition fees at Kestora University?",
        answer: (
    ...
    },
    {
        ...
        answer: (
            <div className="space-y-4">
                <p>
                    Kestora University partners with                     <strong><a href="https://www.flywire.com/" target="_blank" rel="noopener noreferrer" className="underline hover:text-black transition-colors">Flywire</a></strong> to process tuition payments securely and efficiently
        ...
        answer: (
            <div className="space-y-4">
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>The full (discounted) payment must reach Kestora University's account within <strong>7 days</strong> of the admission offer.</li>
    ...
    },
    {
        ...
        answer: (
            <div className="space-y-4">
                <p>
                    Kestora University rewards academic dedication. Our continuing scholarships (available from the 2nd year onwards)
    ...
    },
    {
        ...
        answer: (
            <div className="space-y-4">
                <p>
                    Yes. Depending on your program and applicant status, Kestora University may require a non-refundable tuition
