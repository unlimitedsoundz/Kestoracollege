            ...
            <div className="container mx-auto px-4 pt-16 pb-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-6 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/about-kestora-college" className="text-neutral-400 text-sm hover:text-white transition-colors">Our Story</Link></li>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 text-neutral-400 text-sm">
                                ...
                                <div className="space-y-1.5">
                                    <span className="block">Kestora College – Helsinki Campus</span>
                            ...
                            <li className="flex items-center gap-3 text-neutral-400 text-sm">
                                ...
                                <a href="mailto:kestora@kestora.fi" className="hover:text-white transition-colors">Kestora@kestora.fi</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-neutral-500 text-xs order-2 md:order-1">
                            © 2026 Kestora College – Independent higher education institution in Helsinki, Finland. All rights reserved.
                        </p>
