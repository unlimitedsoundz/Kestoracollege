                    ...
                    <main className="lg:col-span-9 max-w-3xl">
                        ...
                        <div className="prose prose-neutral max-w-none space-y-16">
                            ...
                            <section id="enforcement" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    If a user is not satisfied with the response received from Kestora University they may contact the supervisory authority responsible for monitoring digital accessibility in Finland.
                                </p>
                                <p className="text-neutral-700 leading-relaxed">
