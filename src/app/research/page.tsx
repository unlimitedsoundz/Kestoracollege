...
export const metadata = {
    title: 'Research at Kestora College — Sustainability, Innovation & Technology',
    description: 'Explore research at Kestora College. Funded projects in sustainability, clean technology, design, and social innovation. Publications, labs, and collaboration opportunities.',
};
            ...
            <div className="relative h-auto min-h-[600px] md:pt-48 w-full bg-neutral-900 overflow-hidden pt-32 pb-32">
                <div className="absolute inset-0">
                    <Image
                        ...
                        alt="Researchers collaborating in a modern lab environment at Kestora College"
                        fill
                        priority
                ...
                <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white max-w-4xl leading-tight pt-8">
                        Research & Creative Exploration at Kestora College
                    </h1>
                ...
                <div className="grid md:grid-cols-2 gap-16">
                    ...
                    <div>
                        ...
                        <p className="text-neutral-600 mb-6 text-lg leading-relaxed">
                            All research and creative activity at Kestora College follows clear ethical guidelines and quality standards. Integrity, transparency, and accountability are central to how we work and collaborate.
                        </p>
                        <h3 className="text-xl font-bold mb-4 text-neutral-900 mt-10">Where Disciplines Collide</h3>
                        <p className="text-neutral-600 mb-4">Kestora College supports research through:</p>
            ...
            <div className="bg-neutral-100 py-8 md:py-24 text-center">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-xl text-neutral-600 max-w-2xl mx-auto mb-10">
                        Students and staff are invited to actively engage in research. At Kestora College, research is not just something you study <strong>it’s something you do</strong>.
                    </p>
