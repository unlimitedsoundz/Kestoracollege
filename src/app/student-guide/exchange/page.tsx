                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-xl text-neutral-300 leading-relaxed">
                            Everything you need to know for your exchange semester or year at Kestora College.
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <main className="lg:w-3/4 space-y-8 md:space-y-16">
                        ...
                        <section id="intro" className="scroll-mt-32">
                            <h2 className="text-3xl font-bold mb-6">Welcome to Kestora College!</h2>
                            <p className="text-lg text-neutral-700 leading-relaxed">
                                Completing an exchange at Kestora College is a unique opportunity to experience Finnish education,
                                ...
                                <div className="border border-neutral-200 rounded-xl p-8">
                                    ...
                                    <ul className="space-y-4 text-neutral-600 text-sm">
                                        <li className="flex gap-3">
                                            ...
                                            <span><strong>Initial LA:</strong> Should be signed by your home university and Kestora before arrival.</span>
                                        </li>
                                        <li className="flex gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-black mt-1.5 shrink-0"></div>
                        ...
                        <section id="housing" className="scroll-mt-32">
                            ...
                            <div className="bg-white border border-neutral-200 rounded-xl p-8 mb-6">
                                ...
                                <div className="bg-neutral-50 p-4 rounded-lg flex gap-3 text-sm">
                                    ...
                                    <p>Kestora College does not provide on-campus housing directly, but we assist with the application process.</p>
                                </div>
                            </div>
