                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-xl text-neutral-300 leading-relaxed">
                            Essential steps and instructions for newly admitted Master’s students at Kestora College.
                    ...
                    <main className="lg:w-3/4 space-y-8 md:space-y-16">
                        ...
                        <section id="tuition" className="scroll-mt-32">
                            ...
                            <div className="prose max-w-none text-neutral-700">
                                ...
                                <p className="mb-6">
                                    If you have a <strong>Kestora College Excellence Scholarship</strong>, you must accept the terms before the scholarship is valid.
