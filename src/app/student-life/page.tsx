                    ...
                    <div className="lg:w-1/2 h-full w-full relative mt-8 lg:mt-0 lg:translate-y-16 z-20 flex justify-center lg:block">
                        <div className="relative w-[368px] h-[368px] lg:w-full lg:h-full bg-neutral-800 shadow-2xl">
                            <Image
                                ...
                                alt="Student Life Experiences at Kestora"
                                fill
                                priority
                    ...
                    <main className="lg:w-3/4 space-y-8 md:space-y-24">
                                ...
                                <div>
                                    <div className="relative aspect-square rounded-2xl overflow-hidden bg-neutral-100">
                                        <Image
                                            ...
                                            alt="Kestora University campus location and setting"
                                            fill
                                            className="object-cover"
                                ...
                                <div>
                                    <div className="relative aspect-square rounded-2xl overflow-hidden bg-neutral-100">
                                        <Image
                                            ...
                                            alt="Public transport connections at Kestora University"
                                            fill
                                            className="object-cover"
                                            sizes="(max-width: 1024px) 100vw, 50vw"
                                        />
                        ...
                        <section id="facilities" className="scroll-mt-32">
                            ...
                            <p className="text-lg text-neutral-700 leading-relaxed mb-8">
                                Students at Kestora University have access to a wide range of learning environments designed to support collaboration and innovation.
                            </p>
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                                {[
                                    { title: "Labs & Workshops", image: "/images/student-life/labs.png", credit: "Elina Mäkinen" },
                                ...
                                <div>
                                     <div className="relative aspect-square rounded-2xl overflow-hidden bg-neutral-100">
                                         <Image
                                             ...
                                             alt="Library and Learning Centres at Kestora University"
                                             fill
                                             className="object-cover"
                                             sizes="(max-width: 1024px) 100vw, 50vw"
                                         />
                        ...
                        <section id="future" className="scroll-mt-32">
                            ...
                            <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                                Kestora University continues to develop its campus infrastructure to support modern teaching methods, sustainability goals, and student wellbeing. New buildings and renovated facilities focus on energy efficiency, accessibility, and flexible learning environments.
                            </p>
                        </section>
