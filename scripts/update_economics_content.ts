...
const sections = [
    ...
    },
    {
        ...
        id: "research",
        content: `
            <p class="mb-2">Kestora College Economics Department focuses on:</p>
            <ul class="list-disc pl-5 space-y-1">
    ...
    },
    {
        ...
        id: "contact",
        content: `
            <p><strong>Kestora College School of Business – Economics Department</strong></p>
