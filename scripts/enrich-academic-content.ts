        ...
        const sections = [
            {
                ...
                content: `
                    <p class="mb-4">The ${course.title} at Kestora College offers a rigorous and future-oriented curriculum designed to equip students with the technical skills and theoretical foundation needed to lead in the modern ${course.slug.includes('business') ? 'business' : 'technological'} landscape.</p>
