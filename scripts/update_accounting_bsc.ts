...
const sections = [
    {
        ...
        id: "description",
        content: `
            <p class="mb-4">The Accounting & Finance BSc program at Kestora College provides a solid foundation in accounting, finance, and management. Students gain practical and theoretical knowledge in financial accounting, management accounting, corporate governance, auditing, performance management, and financial decision-making.</p>
    ...
    },
    {
        ...
        content: `
            ...
            <div>
                ...
                <p class="mt-2 text-sm text-neutral-500">Detailed scholarship information is available on the Kestora College Scholarships page.</p>
            </div>
        `
    },
    {
